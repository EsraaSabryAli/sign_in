          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  alignment:
                      Alignment.center, // Aligning the container to center
                  child: ElevatedButton(
                    onPressed: _submitForm,
                    child: Text('Sign Up'),
                    style: ButtonStyle(
                      minimumSize: MaterialStateProperty.all<Size>(
                          Size(327, 50)), // Correctly specifying minimumSize
                      padding: MaterialStateProperty.all<EdgeInsets>(
                        EdgeInsets.symmetric(
                            horizontal: 10, vertical: 10), // Snug padding
                      ),
                ...
                Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: Colors.grey,
                      fontSize:
                          15, // Adjust font size to fit the available space
                    ),
                  ),
                ),
                SizedBox(height: 30),
